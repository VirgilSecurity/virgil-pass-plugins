jQuery(document).ready(function(){
    ...
    var virgil = '<tr class="stop-virgil"><th>&nbsp;</th><td>You are using Virgil Login. To stop using it and start use normal password, please click on this <a href="javascript:void(0);" id="show-new-password">link.</a></td></tr>';
